    ...
    <div class="card1">
      <div class="flex justify-between">
        ...
        <div
          ...
          class="network-dropdown text-xs border borderColor px-2 py-1 rounded flex gap-2 items-center hover:border-gray-400 hover:bg-gray-100 cursor-pointer relative"
...
import AppButton from "../buttons/appButton/appButton.vue";
