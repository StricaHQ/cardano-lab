...
import OutputForm from "../components/outputs/outputForm/outputForm.vue";
import MintForm from "../components/mints/mintForm/mintForm.vue";
import CertificateForm from "../components/certificates/certificateForm/certificateForm.vue";

import { useAccountStore } from "@/stores/accountStore/accountStore";
import { useTransactionsStore } from "../store/store";
import { useInputStore } from "../components/inputs/store/store";
import { useOutputStore } from "../components/outputs/store/store";
import { useMintStore } from "../components/mints/store/store";
import { useCertificateStore } from "../components/certificates/store/store";
...
import AddNewCertificate from "../components/certificates/addNewCertificate/addNewCertificate.vue";
